 ...
 */
@Entity
@NamedQuery(name = BlogEntity.QUERY_BY_ID, query = "SELECT e FROM AntragEntity e WHERE e.id = :" + BlogEntity.QUERY_PARAMETER_ID)
@NamedQuery(name = BlogEntity.QUERY_BY_TITELD, query = "SELECT e FROM AntragEntity e WHERE e.titelDeutsch LIKE :" + BlogEntity.QUERY_PARAMETER_TITELD)
@Table(name = "ANTRAG")
